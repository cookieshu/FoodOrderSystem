        ...
        <table class="table table-striped table-bordered table-hover1  table-condensed">
            ...
            <c:forEach items="${orders}" var="o">
                <tr>
                    ...
                    <td>${o.userMessage}</td>
                    <td><fmt:formatDate value="${o.receiveDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                        ...
                        <div  class="orderPageOrderItem">
                            <table width="800px" align="center" class="orderPageOrderItemTable">
                                <c:forEach items="${o.orderItems}" var="oi">
                                    <tr>
                                        <td align="left">
                                            <img width="40px" height="40px" src="img/foodSingle/${oi.food.firstFoodImage.id}.jpg">
                                        </td>

                                        <td>
                                            <a href="foreproduct?pid=${oi.food.id}">
                                                <span>${oi.food.name}</span>
                                            </a>
                                        </td>
                                        ...
                                        <td align="right">
                                            ...
                                            <span class="text-muted">单价：￥${oi.food.price}</span>
                                        </td>
