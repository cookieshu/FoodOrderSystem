    ...
    <div class="confirmPayOrderItemDiv">
        ...
        <table class="confirmPayOrderItemTable">
            ...
            <c:forEach items="${o.orderItems}" var="oi">
                <tr>
                    <td><img width="50px" src="img/productSingle_middle/${oi.food.firstFoodImage.id}.jpg"></td>
                    <td class="confirmPayOrderItemProductLink">
                        <a href="#nowhere">${oi.food.name}</a>
                    </td>
                    <td>￥<fmt:formatNumber type="number" value="${oi.food.price}" minFractionDigits="2"/></td>
                    <td>1</td>
                    <td><span class="conformPayProductPrice">￥<fmt:formatNumber type="number" value="${oi.food.price}" minFractionDigits="2"/></span></td>
