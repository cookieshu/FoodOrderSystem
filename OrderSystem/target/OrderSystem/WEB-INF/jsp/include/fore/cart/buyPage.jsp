            ...
            <table class="productListTable">
                ...
                <c:forEach items="${ois}" var="oi" varStatus="st" >
                    <tr class="orderItemTR">
                        <td class="orderItemFirstTD"><img class="orderItemImg" src="img/foodSingle_middle/${oi.food.firstFoodImage.id}.jpg"></td>
                        <td class="orderItemProductInfo">
                            <a  href="/forefood?fid=${oi.food.id}" class="orderItemProductLink">
                                    ${oi.food.name}
                            </a>
                        ...
                        <td>
                            ...
                            <span class="orderItemProductPrice">￥<fmt:formatNumber type="number" value="${oi.food.price}" minFractionDigits="2"/></span>
                        </td>
                        <td>
                            <span class="orderItemProductNumber">${oi.number}</span>
                        </td>
                        <td><span class="orderItemUnitSum">
                        ￥<fmt:formatNumber type="number" value="${oi.number*oi.food.price}" minFractionDigits="2"/>
                        </span></td>
