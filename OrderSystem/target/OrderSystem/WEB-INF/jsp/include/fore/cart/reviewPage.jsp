...
<div class="reviewDiv">
    <div class="reviewProductInfoDiv">
        <div class="reviewProductInfoImg"><img width="400px" height="400px" src="img/productSingle/${food.firstFoodImage.id}.jpg"></div>
        <div class="reviewProductInfoRightDiv">
            ...
            <table class="reviewProductInfoTable">
                <tr>
                    <td width="75px">价格:</td>
                    <td><span class="reviewProductInfoTablePrice">￥<fmt:formatNumber type="number" value="${food.price}" minFractionDigits="2"/></span> 元 </td>
                </tr>
                <tr>
                    <td>配送</td>
                    <td>快递:  0.00</td>
                ...
                <tr>
                    <td>月销量:</td>
                    <td><span class="reviewProductInfoTableSellNumber">${food.saleCount}</span> 件</td>
                </tr>
            </table>
...
于<fmt:formatDate value="${o.createDate}" pattern="yyyy年MM月dd"/>下单购买了此商品 </span>
    ...
    <div class="reviewStasticsDiv">
        <div class="reviewStasticsLeft">
            ...
            <div class="reviewStasticsLeftContent">累计评价 <span class="reviewStasticsNumber"> ${food.reviewCount}</span></div>
